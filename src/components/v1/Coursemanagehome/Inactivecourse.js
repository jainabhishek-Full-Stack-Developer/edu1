...
const Inactivecourse = () => {
    ...
    const handleDeactiveCourse = useCallback((uuid) => {
        Swal.fire({
            title: 'Are you sure?',
            text: 'Do you want to active this course?',
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                // refetch();
                Swal.fire('Deactivated!', 'The course has been Active.', 'success');
            }
        });
    }, []);
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Easy</td>
                        <td>
                            <button type="button" className={styles.tableDeactiveBtn} onClick={() => handleDeactiveCourse('abc')}>Deative</button>
