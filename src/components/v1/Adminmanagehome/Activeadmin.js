...
const Activeadmin = () => {
    ...
    const handleDeactiveAdmin = useCallback((uuid) => {
        Swal.fire({
            title: 'Are you sure?',
            ...
            if (result.isConfirmed) {
                ...
                // refetch();
                Swal.fire('Deactivated!', 'The item has been deactivated.', 'success');
            }
        });
    }, []);
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <button type="button" className={styles.tableActiveBtn} onClick={() => handleDeactiveAdmin('abc')} >Active</button>
