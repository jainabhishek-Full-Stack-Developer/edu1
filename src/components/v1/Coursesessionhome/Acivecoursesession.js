                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <button type="button" className={styles.tableActiveBtn} onClick={() => handleDeactiveSession('abc')} >Active</button>
...
export default Acivecoursesession;
