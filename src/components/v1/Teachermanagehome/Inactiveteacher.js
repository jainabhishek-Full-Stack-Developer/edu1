...
const Inactiveteacher = () => {
    ...
    const handleActiveTeacher = useCallback((uuid) => {
        Swal.fire({
            title: 'Are you sure?',
            ...
            if (result.isConfirmed) {
                ...
                // refetch();
                Swal.fire('Activate!', 'The teacher has been Activate.', 'success');
            }
        });
    }, []);
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <button type="button" className={styles.tableDeactiveBtn} onClick={() => handleActiveTeacher('abc')} >Deactive</button>
