                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <button type="button" className={styles.tableDeactiveBtn} onClick={() => handleDeactiveStudent('abc')} >Deactive</button>
...
export default Inactivestduent;
