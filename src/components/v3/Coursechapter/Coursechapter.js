...
const Coursechapter = () => {
    return (
        <div className={styles.courseContentSectionWrapper}>
            <div>
                <h1 className={styles.courseContentSectionHeading}>Course Content</h1>
            </div>
            <Accordion allowZeroExpanded> {/* allowZeroExpanded allows multiple panels to be open */}
                <AccordionItem className={styles.courseContentItm}>
                    <AccordionItemHeading>
                        <AccordionItemButton>
